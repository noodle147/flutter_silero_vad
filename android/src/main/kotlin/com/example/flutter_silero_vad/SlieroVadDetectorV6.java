 ...
 * @author VvvvvGH
 */
public class SlieroVadDetectorV6 {
    // ONNX model for speech processing
    private final SlieroVadOnnxModelV6 model;
    ...
    public SlieroVadDetectorV6(String modelPath,
        ...
        this.model = new SlieroVadOnnxModelV6(modelPath);
